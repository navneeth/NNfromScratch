...
from layers import forward_step, backward_step
########################################################
# Define a sample model to be trained on the data
hidden_neurons_1 = 8  # Number of neurons in the first hidden-layer
...
max_nb_of_iterations = 3000 # Train for a maximum of 300 iterations
